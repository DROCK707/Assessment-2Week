...
const canWeDeliver = (zipCode, array) => {
...
canWeDeliver(84043, deliveryAreaZipCodes)
...
const canWeDeliverTwo = (zipCode, array) => {
    if (array.includes(zipCode)) {
...
canWeDeliverTwo(85205, deliveryAreaZipCodes)
