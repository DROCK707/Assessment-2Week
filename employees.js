...
class Employee {
    ...
    getSchedule = () => {
        console.log(`${this.name} works on ${this.shifts[0]} and ${this.shifts[1]}`)
    }
}
/*
...
let empOne = new Employee("Derrick", ["weekday mornings", "weekday afternoons"])
...
let manager = new Manager("Dane", ["weekday mornings", "weekday afternoons"], ["Cece", "Schmidt"])
